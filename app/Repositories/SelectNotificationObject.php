...
use App\Http\Resources\Notifications\BookmarksAddedToFolderNotificationResource as NewBookmarksResource;
use App\Http\Resources\Notifications\CollaboratorExitNotificationResource;
use App\Http\Resources\Notifications\FolderBookmarksRemovedNotificationResource as BookmarksDeletedResource;
...
final class SelectNotificationObject
{
    ...
    public function __invoke(DatabaseNotification $notification): TransformsNotificationInterface
    {
        return match ($notification->notificationType) {
            Type::BOOKMARKS_ADDED_TO_FOLDER => new NewBookmarksResource($notification, $this->repository),
            Type::BOOKMARKS_REMOVED_FROM_FOLDER => new BookmarksDeletedResource($notification, $this->repository),
