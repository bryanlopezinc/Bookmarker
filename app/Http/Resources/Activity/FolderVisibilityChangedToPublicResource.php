...
final class FolderVisibilityChangedToPublicResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $visibility = FolderVisibility::PUBLIC->toWord();

        return [
            'type'       => 'FolderVisibilityChangedToPublicActivity',
            'attributes' => [
