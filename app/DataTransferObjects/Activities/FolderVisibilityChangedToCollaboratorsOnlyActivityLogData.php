...
final class FolderVisibilityChangedToCollaboratorsOnlyActivityLogData implements Arrayable
{
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new FolderVisibilityChangedToCollaboratorsOnlyActivityLogData($collaborator);
    }
