...
use App\Import\Contracts\BookmarkImportedListenerInterface;
use App\Import\Contracts\ImportFailedListenerInterface;
use App\Import\Importer;
use Illuminate\Contracts\Filesystem\FileNotFoundException;
use PHPUnit\Framework\MockObject\MockObject;
use App\Import\Filesystem;
use App\Import\HtmlFileIterator;
...
class ImporterTest extends TestCase
{
    ...
    {
        return View::file(base_path("tests/stubs/Imports/{$file}.blade.php"))
