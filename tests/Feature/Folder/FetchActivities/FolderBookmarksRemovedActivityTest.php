...
class FolderBookmarksRemovedActivityTest extends TestCase
{
    ...
    {
        $this->createFolderActivity = new CreateFolderActivity(ActivityType::BOOKMARKS_REMOVED);
    }
    ...
    public function fetch(): void
    {
        ...
        $this->fetchActivitiesTestResponse(['folder_id' => $folder->public_id->present()])
            ...
            ->assertJsonPath('data.0.type', 'FolderBookmarksRemovedActivity')
            ->assertJsonPath('data.0.attributes.message', 'You removed 1 bookmark')
    ...
    public function whenCollaboratorNoLongerExist(): void
    {
        ...
        $this->fetchActivitiesTestResponse(['folder_id' => $folder->public_id->present()])
            ->assertOk()
            ->assertJsonPath('data.0.attributes.message', 'Jack Sparrow removed 2 bookmarks')
