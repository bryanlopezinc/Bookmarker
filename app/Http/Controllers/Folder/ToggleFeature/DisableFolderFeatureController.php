...
use App\Models\User;
use App\Services\Folder\DisableFolderFeatureService;
use App\ValueObjects\PublicId\FolderPublicId;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;

final class DisableFolderFeatureController
{
    use ValidatesAttributes;

    public function __invoke(Request $request, DisableFolderFeatureService $service, string $folderId, string $feature): JsonResponse
    {
